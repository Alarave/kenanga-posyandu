<div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-100 pb-4">
    ...
    {{-- Current Date Badge --}}
    <div class="flex items-center gap-2 text-xs font-black text-slate-500 bg-slate-100/80 border border-slate-200 px-3.5 py-2 rounded-2xl shadow-sm whitespace-nowrap max-w-fit" style="font-family:'Public Sans', 'Public Sans Fallback', sans-serif;">
