...
<div class="grid grid-cols-2 md:grid-cols-4 gap-3">
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-3 flex items-center gap-3">
        ...
        <div>
            <p class="text-[11px] font-medium text-slate-500 leading-none mb-1">Bayi (0-11 bln)</p>
            <h4 class="text-xl font-bold text-slate-800 leading-none">{{ number_format($bayi) }}</h4>
        </div>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-3 flex items-center gap-3">
        ...
        <div>
            <p class="text-[11px] font-medium text-slate-500 leading-none mb-1">Baduta (12-23 bln)</p>
            <h4 class="text-xl font-bold text-slate-800 leading-none">{{ number_format($baduta) }}</h4>
        </div>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-3 flex items-center gap-3">
        ...
        <div>
            <p class="text-[11px] font-medium text-slate-500 leading-none mb-1">Balita (24-59 bln)</p>
            <h4 class="text-xl font-bold text-slate-800 leading-none">{{ number_format($balita) }}</h4>
        </div>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-3 flex items-center gap-3">
        ...
        <div>
            <p class="text-[11px] font-medium text-slate-500 leading-none mb-1">Anak Sekolah</p>
            <h4 class="text-xl font-bold text-slate-800 leading-none">{{ number_format($anakSekolah) }}</h4>
        </div>
    </div>

    {{-- 5. Ibu Hamil --}}
    <div class="bg-white border border-slate-200 rounded-xl p-3 flex items-center gap-3">
        <div class="w-10 h-10 rounded-full bg-pink-50 text-pink-600 flex items-center justify-center shrink-0">
            <span class="material-symbols-outlined text-[22px]">pregnant_woman</span>
        </div>
        <div>
            <p class="text-[11px] font-medium text-slate-500 leading-none mb-1">Ibu Hamil</p>
            <h4 class="text-xl font-bold text-slate-800 leading-none">{{ number_format($ibuHamil) }}</h4>
        </div>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-3 flex items-center gap-3">
        ...
        <div>
            <p class="text-[11px] font-medium text-slate-500 leading-none mb-1">Remaja</p>
            <h4 class="text-xl font-bold text-slate-800 leading-none">{{ number_format($remaja) }}</h4>
        </div>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-3 flex items-center gap-3">
        ...
        <div>
            <p class="text-[11px] font-medium text-slate-500 leading-none mb-1">Lansia</p>
            <h4 class="text-xl font-bold text-slate-800 leading-none">{{ number_format($lansia) }}</h4>
        </div>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-3 flex items-center gap-3">
        ...
        <div>
            <p class="text-[11px] font-medium text-slate-500 leading-none mb-1">Umum / Lainnya</p>
            <h4 class="text-xl font-bold text-slate-800 leading-none">{{ number_format($umum) }}</h4>
        </div>
    </div>
</div>
