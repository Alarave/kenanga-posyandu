...
<div 
    x-data="{ 
        ...
        config: {
            ...
            error: { bg: 'bg-red-50', border: 'border-error', text_bold: 'text-red-800', text_dim: 'text-red-700', icon: 'error', icon_color: 'text-error', btn_color: 'text-red-500 hover:text-red-700', title: 'Kesalahan!' },
    ...
    role="alert"
>
    <span class="material-symbols-outlined text-headline-sm" :class="config[nType].icon_color" x-text="config[nType].icon"></span>
    <div class="flex-1">
