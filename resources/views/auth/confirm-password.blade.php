...
@section('content')
    <div class="max-w-md mx-auto mt-12 bg-white p-6 rounded-lg shadow-md">
        <h2 class="text-headline-md font-semibold text-teal-500 mb-6">Confirm Your Password</h2>
        ...
        <form method="POST" action="{{ route('password.confirm') }}">
            ...
            <button type="submit" class="bg-primary text-white px-6 py-2 rounded-lg hover:bg-primary w-full">
                Confirm Password
            </button>
        </form>
    </div>
