...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .hero-heading .img-pill:hover { transform: rotate(0deg); }
    ...
    .hero-img-main:hover { transform: rotate(0deg); }
    .hero-img-main img {
        width: 100%;
        height: 100%;
        object-fit: cover;
    ...
    .hero-float-card:hover { transform: rotate(0deg); }
    ...
    .hero-float-card .label { font-size: 13px; font-weight: 700; color: #0f172a; }
    .hero-float-card .sublabel { font-size: 10px; font-weight: 600; color: #0d9488; text-transform: uppercase; letter-spacing: 0.08em; }
    ...
    .feature-icon.teal { background: #f0fdf9; color: #0d9488; }
    .feature-card:hover .feature-icon.teal { background: #0d9488; color: #ffffff; }

    .feature-icon.blue { background: #eff6ff; color: #2563eb; }
    .feature-card:hover .feature-icon.blue { background: #2563eb; color: #ffffff; }

    .feature-icon.indigo { background: #eef2ff; color: #4f46e5; }
    .feature-card:hover .feature-icon.indigo { background: #4f46e5; color: #ffffff; }

    .feature-card-content { position: relative; z-index: 1; margin-top: 28px; }
    .feature-card-title {
        font-size: 20px;
        font-weight: 800;
        letter-spacing: -0.02em;
    ...
    @media (min-width: 768px) {
        .schedule-grid { grid-template-columns: repeat(12, 1fr); }
    }
    ...
    @media (min-width: 768px) {
        .schedule-card:first-child { grid-column: span 7; }
        .schedule-card:not(:first-child) { grid-column: span 5; }
    }
    .schedule-card:hover {
        border-color: #0d9488;
        box-shadow: 0 12px 30px rgba(13,148,136,0.04);
        transform: translateY(-3px);
    }

    .schedule-card-inner { padding: 36px; height: 100%; display: flex; flex-direction: column; justify-content: space-between; }

    .schedule-card-top { margin-bottom: 24px; }
    ...
    .schedule-card:hover .schedule-title { color: #0d9488; }
    ...
    .meta-icon .material-symbols-outlined { font-size: 17px; }
    .meta-icon.teal { background: #f0fdf9; color: #0d9488; }
    .meta-icon.amber { background: #fffbeb; color: #d97706; }
    ...
    .empty-state:hover { border-color: transparent; }
    .empty-icon {
        width: 72px;
        height: 72px;
        background: #f0fdf9;
    ...
    .empty-icon .material-symbols-outlined { font-size: 34px; color: #0d9488; }
    .empty-title {
        font-size: 20px;
        font-weight: 800;
        color: #0f172a;
    ...
    .article-card:hover .article-title { color: #0d9488; }
    ...
    .article-arrow .material-symbols-outlined { font-size: 16px; }
    ...
    .cta-heading .highlight { color: #5eead4; }
    ...
    <div class="hero-container">
        ...
        <div id="hero-text">
            ...
            <h1 class="hero-heading">
                Modernisasi<span class="img-pill" style="display:inline-block;width:60px;height:44px;border-radius:100px;overflow:hidden;vertical-align:middle;margin:0 10px;border:2px solid #e2e8f0;transform:rotate(-4deg);transition:transform 0.4s ease;"><img src="{{ asset('assets/img/carousel_1.png') }}" onerror="this.src='{{ asset('assets/img/tim-kenanga.jpg') }}'" alt="" style="width:100%;height:100%;object-fit:cover;"></span>Layanan <span class="accent">Posyandu Kita.</span>
            </h1>

            <p class="hero-desc">
                Transformasi sistem informasi kesehatan dasar melalui manajemen data terintegrasi. Memantau tumbuh kembang anak kini lebih praktis, transparan, and akurat.
            </p>
...
<div class="page-wrapper">
    ...
    <section class="section" id="fitur-section">
        <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:48px;" id="fitur-header">
            <div class="eyebrow">Solusi Kami</div>
            ...
            <p style="font-size:15px;color:#64748b;line-height:1.7;max-width:520px;margin:8px 0 0;">
                Kepraktisan pencatatan data balita, jadwal pemeriksaan real-time, dan grafik perkembangan kesehatan—dalam satu platform terintegrasi.
            </p>
        </div>
        ...
        <div class="feature-grid">
            ...
            <div class="feature-card">
                <div class="feature-card-bg teal"></div>
                <div class="feature-icon teal">
                    <span class="material-symbols-outlined">monitoring</span>
                </div>
                <div class="feature-card-content">
                    <h4 class="feature-card-title">Monitoring Digital</h4>
                    <p class="feature-card-desc">Catat hasil pengukuran berat badan, tinggi badan, lingkar kepala, dan data pertumbuhan secara instan dan aman.</p>
                </div>
            </div>

            {{-- Fitur 2 --}}
            <div class="feature-card">
                <div class="feature-card-bg blue"></div>
                <div class="feature-icon blue">
                    <span class="material-symbols-outlined">calendar_today</span>
                </div>
                <div class="feature-card-content">
                    <h4 class="feature-card-title">Jadwal Terpadu</h4>
                    <p class="feature-card-desc">Pantau dan dapatkan notifikasi jadwal imunisasi serta pemeriksaan posyandu di setiap pedukuhan.</p>
                </div>
            </div>

            {{-- Fitur 3 --}}
            <div class="feature-card">
                <div class="feature-card-bg indigo"></div>
                <div class="feature-icon indigo">
                    <span class="material-symbols-outlined">analytics</span>
                </div>
                <div class="feature-card-content">
                    <h4 class="feature-card-title">Laporan Akurat</h4>
                    <p class="feature-card-desc">Akses grafik pertumbuhan standar WHO dan laporan status gizi real-time untuk penanganan stunting yang lebih responsif.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="jadwal" class="section" style="scroll-margin-top: 24px;">
        <div class="schedule-header" id="jadwal-header">
            <div>
                <div class="eyebrow">Agenda Terdekat</div>
                ...
                <div class="schedule-card-inner">
                    <div class="schedule-card-top">
                        <div class="schedule-top-row">
                            <span class="badge-status {{ $schedule->status === 'ongoing' ? 'ongoing' : 'upcoming' }}">
                    ...
                    <div class="schedule-meta">
                        <div class="meta-item">
                            ...
                            <div>
                                ...
                                <div class="meta-value">{{ \Carbon\Carbon::parse($schedule->start_time)->translatedFormat('d M Y') }}</div>
                            </div>
                        </div>
                        <div class="meta-item">
        ...
        <div class="empty-state">
            ...
            <p class="empty-desc">Belum ada kegiatan posyandu yang dijadwalkan. Kunjungi kembali halaman ini secara berkala.</p>
        </div>
        @endif
    </section>
    ...
    <section class="section" id="artikel-section">
        <div class="articles-header">
            <div>
                <div class="eyebrow">Literasi Sehat</div>
    ...
    <div class="cta-section" id="cta-section">
        ...
        <div class="cta-inner">
            ...
            <p class="cta-desc">
                Ada pertanyaan seputar program kesehatan posyandu atau butuh panduan pendaftaran? Hubungi tim pelayanan kami.
            </p>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (document.querySelector("#fitur-section .feature-card")) {
        gsap.from("#fitur-section .feature-card", {
            scrollTrigger: { trigger: "#fitur-section", start: "top 90%", toggleActions: "play none none none" },
            duration: 0.7,
            y: 36,
            opacity: 0,
            stagger: 0.1,
    ...
    if (document.querySelector("#jadwal-grid")) {
        gsap.from("#jadwal-grid > *", {
            scrollTrigger: { trigger: "#jadwal", start: "top 90%", toggleActions: "play none none none" },
            duration: 0.8,
            y: 32,
            opacity: 0,
            stagger: 0.12,
    ...
    if (document.querySelector("#artikel-section .article-card")) {
        gsap.from("#artikel-section .article-card", {
            scrollTrigger: { trigger: "#artikel-section", start: "top 95%", toggleActions: "play none none none" },
            duration: 0.7,
            y: 28,
            opacity: 0,
            stagger: 0.1,
