...
<section class="pt-10 pb-20 lg:pt-14 lg:pb-28 bg-slate-50 dark:bg-slate-950 border-t border-slate-100 dark:border-slate-800/60 relative">
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div class="flex justify-center mt-4">
            <span class="inline-flex items-center justify-center px-5 py-2 rounded-full bg-teal-50/50 dark:bg-teal-950/20 text-primary dark:text-teal-400 font-extrabold text-xs md:text-sm tracking-wide border border-teal-100/40 dark:border-teal-900/40 font-jakarta shadow-xs">
        ...
        <p class="text-center max-w-3xl mx-auto text-base md:text-lg text-slate-655 dark:text-slate-400 mt-8 leading-relaxed font-semibold italic">
