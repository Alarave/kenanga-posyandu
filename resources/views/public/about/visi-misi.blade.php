{{-- ── 4. VISI & MISI SECTION ── --}}
<section class="pt-10 pb-10 lg:pt-14 lg:pb-14 bg-surface-container-low dark:bg-slate-950 border-y border-slate-100 dark:border-slate-800/80 relative overflow-hidden">
    <div class="absolute top-0 right-0 w-125 h-125 bg-primary/5 rounded-lg blur-[120px] -translate-y-1/2 translate-x-1/4 opacity-40"></div>
    <div class="absolute bottom-0 left-0 w-100 h-100 bg-primary/5 rounded-lg blur-[100px] translate-y-1/3 -translate-x-1/4 opacity-30"></div>
    
    <div class="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        
        {{-- Badge (centered) --}}
        <div class="flex justify-center mb-4">
            <span class="inline-flex items-center gap-2 px-3.5 py-1.5 bg-primary/10 rounded-lg border border-primary/20 text-xs md:text-sm font-black text-primary uppercase tracking-[0.2em]">
        ...
        {{-- Title (centered) --}}
        <h2 class="text-center text-display-sm md:text-5xl font-black text-on-surface dark:text-white tracking-tight font-jakarta leading-normal max-w-4xl mx-auto py-2">
        ...
        <p class="text-center max-w-3xl mx-auto text-base md:text-body-lg text-on-surface-variant dark:text-outline-variant mt-6 leading-relaxed font-semibold italic">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
            @foreach($misis as $m)
            <div class="bg-white dark:bg-inverse-surface border border-outline-variant/60 dark:border-slate-800 rounded-2xl p-8 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
