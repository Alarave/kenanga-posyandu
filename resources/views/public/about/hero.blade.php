        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div class="lg:col-span-7 space-y-6 text-left">
                ...
                <h1 class="text-4xl md:text-6xl font-black text-slate-900 dark:text-white tracking-tight font-jakarta leading-[1.15] py-2">
                    Mitra Masyarakat<br/>
                    <span class="inline-block text-transparent bg-clip-text bg-gradient-to-r from-primary to-teal-500 dark:from-teal-300 dark:to-emerald-400 italic pl-2 pr-8 py-2 -mr-6">Menuju Hidup Sehat.</span>
                </h1>
            ...
            <div class="lg:col-span-5 relative">
                <div class="relative mx-auto max-w-[450px] lg:max-w-none">
                    ...
                    <div class="relative overflow-hidden rounded-[2rem] border border-white dark:border-slate-800 shadow-2xl bg-white dark:bg-slate-900 p-4">
                        <img src="{{ asset('assets/img/about_hero_illustration.png') }}" alt="Posyandu Kenanga Illustration" class="w-full h-auto object-contain rounded-2xl transform hover:scale-[1.01] transition-transform duration-500 max-h-[420px]">
                    </div>
