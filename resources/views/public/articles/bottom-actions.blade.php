<div class="mt-12 flex items-center justify-between bg-inverse-surface p-8 md:p-12 rounded-[3rem] text-white shadow-2xl relative overflow-hidden">
    ...
    <div class="flex gap-4 relative z-10">
        ...
        <a href="{{ route('public.articles.index') }}" class="h-14 px-8 flex items-center gap-3 bg-white text-on-surface rounded-2xl font-black uppercase tracking-widest text-[11px] hover:bg-indigo-500 hover:text-white transition-all shadow-xl active:scale-95">
