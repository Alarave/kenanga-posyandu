...
<head>
    ...
    <title>503 - Layanan Tidak Tersedia | Posyandu Kenanga</title>
        ...
        <div class="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px] my-auto py-12">
            ...
            <div class="block dark:hidden mx-auto text-white dark:text-gray-900">
                <svg width="472" height="158" viewBox="0 0 472 158" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-auto">
                    ...
                    <g>
                        <polygon points="236,20 166,134 306,134" stroke="#465FFF" stroke-width="16" stroke-linejoin="round" fill="none"/>
                        <rect x="232" y="55" width="8" height="36" rx="4" fill="#465FFF"/>
                        <circle cx="236" cy="110" r="6" fill="#465FFF"/>
                    </g>
                    <!-- Right Gear -->
                    <g>
            ...
            <div class="hidden dark:block mx-auto text-white dark:text-gray-900">
                <svg width="472" height="158" viewBox="0 0 472 158" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-auto">
                    ...
                    <!-- Center Warning Triangle -->
                    <g>
                        <polygon points="236,20 166,134 306,134" stroke="#7592FF" stroke-width="16" stroke-linejoin="round" fill="none"/>
                        <rect x="232" y="55" width="8" height="36" rx="4" fill="#7592FF"/>
                        <circle cx="236" cy="110" r="6" fill="#7592FF"/>
                    </g>
                    <!-- Right Gear -->
                    <g>
