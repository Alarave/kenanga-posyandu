...
<head>
    ...
    <title>419 - Sesi Berakhir | Posyandu Kenanga</title>
...
<body class="antialiased overflow-x-hidden bg-white dark:bg-gray-900 text-gray-800 dark:text-white/90">
    <div class="relative flex flex-col justify-between min-h-screen p-6 overflow-hidden z-10">
        ...
        <div class="mx-auto w-full max-w-60.5 text-center sm:max-w-118 my-auto py-12">
            ...
            <div class="w-24 h-24 rounded-full bg-rose-50 dark:bg-rose-950/30 text-rose-500 flex items-center justify-center mx-auto mb-8 shadow-sm">
                <span class="material-symbols-outlined text-[48px] animate-pulse">lock_clock</span>
            </div>

            <h1 class="mb-4 font-black tracking-tight text-gray-800 dark:text-white/90 text-3xl sm:text-4xl font-outfit uppercase">
                Sesi Berakhir
            </h1>

            <p class="mt-4 mb-8 text-base text-gray-600 dark:text-gray-400 sm:text-lg font-jakarta">
                Sesi login Anda telah kedaluwarsa secara otomatis demi keamanan data. Silakan masuk kembali ke aplikasi.
            </p>

            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="{{ route('login') }}" class="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-teal-600 hover:bg-teal-700 px-6 py-3.5 text-sm font-bold text-white shadow-lg shadow-teal-600/25 transition-all duration-300 transform hover:-translate-y-0.5">
                    <span class="material-symbols-outlined text-[18px]">login</span>
                    Masuk Kembali
                </a>
                <a href="{{ url('/') }}" class="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-gray-800 dark:hover:bg-gray-700 px-6 py-3.5 text-sm font-bold text-slate-700 dark:text-gray-300 transition-all duration-300 transform hover:-translate-y-0.5">
