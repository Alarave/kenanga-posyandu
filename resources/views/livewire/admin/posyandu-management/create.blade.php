        ...
        <form action="{{ route('admin.posyandu.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-5">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <x-forms.select-input name="pedukuhan_id" placeholder="Pilih Pedukuhan" :placeholderDisabled="true" value="{{ old('pedukuhan_id') }}" class="!pl-10 !h-11 !rounded-xl !border-slate-300 focus:!border-teal-500 focus:!ring-teal-500/20 !shadow-none" :error="$errors->has('pedukuhan_id')">
