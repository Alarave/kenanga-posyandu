...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-headline-sm font-bold text-on-surface">Tambah Posyandu Baru</h1>
            <p class="text-sm text-outline mt-0.5">Daftarkan unit posyandu baru ke sistem</p>
        </div>
    ...
    <div class="bg-white border border-outline-variant rounded-2xl shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-outline-variant flex items-center gap-3">
            ...
            <div>
                <h2 class="text-sm font-bold text-on-surface">Informasi Posyandu</h2>
    ...
    'border-red-400 bg-red-50' => $errors->has('name')
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <x-forms.select-input name="pedukuhan_id" placeholder="Pilih Pedukuhan" :placeholderDisabled="true" value="{{ old('pedukuhan_id') }}" class="!pl-10 !h-11 !rounded-xl !border-outline-variant focus:!border-primary focus:!ring-primary/20 !shadow-none" :error="$errors->has('pedukuhan_id')">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="unique_code" value="{{ old('unique_code') }}"
                               ...
                               @class([
    'w-full h-11 pl-10 pr-4 rounded-xl border border-outline-variant text-sm font-medium text-on-surface placeholder:text-outline-variant focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition',
    'border-red-400 bg-red-50' => $errors->has('unique_code')
])>
                    </div>
                    @error('unique_code')
