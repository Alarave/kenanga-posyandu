<div class="max-w-[1440px] mx-auto space-y-8 pb-20" x-data="{ mediaFilter: 'all' }">
    ...
    @if($galleries->isEmpty())
        <div class="bg-white rounded-[2.5rem] border border-slate-100 py-24 text-center">
            ...
            <h3 class="text-lg font-black text-slate-800 mb-1">Belum ada Media</h3>
            <p class="text-sm text-slate-400 font-medium mb-8">Unggah file foto atau video kegiatan Posyandu Anda di sini.</p>
                    ...
                    <div class="aspect-[4/3] relative overflow-hidden bg-slate-950 flex items-center justify-center">
                        ...
                        @if($gallery->is_featured)
                            <div class="absolute top-4 left-4 z-20">
                                <div class="bg-white/95 text-slate-800 backdrop-blur px-3 py-1.5 rounded-full flex items-center gap-1.5 border border-white/50 shadow-md">
