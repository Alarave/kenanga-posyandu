            ...
            <div class="space-y-8">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $folder->name) }}" placeholder="Contoh: Imunisasi Bulan April 2026" class="w-full h-12 bg-slate-50 border-transparent focus:bg-white focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 rounded-2xl px-5 text-sm font-semibold text-slate-700 transition-all border-2 border-slate-100" required>
                    ...
                    @if(auth()->user()->isSuperAdmin())
                        <div>
                            ...
                            <x-forms.select-input name="posyandu_id" placeholder="Pilih Posyandu (Opsional)" :placeholderDisabled="false" value="{{ old('posyandu_id', $folder->posyandu_id) }}" class="!bg-slate-50 !border-slate-100 !rounded-2xl !h-12 focus:!ring-2 focus:!ring-teal-500/20 focus:!border-teal-500 focus:!bg-white !shadow-none !border-2">
