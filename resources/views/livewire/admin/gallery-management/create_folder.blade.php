...
@section('admin-title')
    Tambah Folder Galeri
@endsection

@section('admin-content')
<div class="flex justify-between items-center mb-6">
    <div>
        <h2 class="text-3xl font-black text-slate-800 tracking-tight">Tambah Folder Baru</h2>
        <p class="text-sm text-slate-400 font-medium mt-1">Buat wadah baru untuk menampung dokumentasi foto dan video kegiatan Posyandu.</p>
    </div>
    <x-breadcrumb :items="[
        ['label' => 'Galeri', 'url' => route('admin.gallery.index')],
        ['label' => 'Tambah Folder', 'active' => true]
    ]" />
</div>
        ...
        <div class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Kegiatan Imunisasi Imela Balita 2026" class="w-full h-12 bg-slate-50 border-transparent rounded-2xl px-5 text-sm font-semibold text-slate-700 focus:bg-white focus:ring-0 focus:border-teal-500 transition-all border-2 border-slate-100" required>
