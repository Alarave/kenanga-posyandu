...
<div class="bg-white border-x border-outline-variant px-8 md:px-12 py-8">
    ...
    <div class="space-y-5">
        ...
        @foreach($content_blocks as $index => $block)
            ...
            <div
                ...
                class="border rounded-xl p-5 bg-surface-container-low">

                {{-- Header --}}
                <div class="flex justify-between items-center mb-4">

                    <div class="font-bold text-sm text-on-surface-variant">
