...
@else
    {{-- Riwayat Pemeriksaan untuk Non-balita --}}
    <div class="bg-white rounded-[3rem] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-slate-100">
        <div class="flex items-center justify-between mb-8">
            <div class="flex items-center gap-4">
                <div class="w-12 h-12 rounded-2xl bg-surface-container-low flex items-center justify-center text-outline-variant">
    ...
    {{-- Grafik Pemantauan Kesehatan Berkala untuk Non-balita --}}
    <div class="bg-white rounded-[3rem] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-slate-100 overflow-hidden relative group"
         x-data="{ 
            chart: null,
            hasData: true,
            initChart(chartData) {
                ...
                // Add default points design for non-balita charts
                    ...
                    options: {
                        ...
                        scales: {
                            x: { 
                                grid: { color: 'rgba(15, 23, 42, 0.05)', drawBorder: false }, 
                                ticks: { color: '#475569', font: { size: 10, weight: '700' } },
                                title: { display: true, text: 'TANGGAL KUNJUNGAN', color: '#1e293b', font: { weight: '800', size: 11, family: 'Inter' } }
                            },
                            y: { 
                                grid: { color: 'rgba(15, 23, 42, 0.05)', drawBorder: false }, 
                                ticks: { color: '#475569', font: { size: 10, weight: '700' } },
                                title: { display: true, text: 'NILAI PENGUKURAN', color: '#1e293b', font: { weight: '800', size: 11, family: 'Inter' } }
                            }
                        },
                        plugins: {
                            legend: { 
    ...
    >
        ...
        <div class="relative z-10 min-h-162.5 h-[75vh] w-full" wire:ignore>
            <canvas id="healthTrendChart" class="h-full! w-full!" x-show="hasData"></canvas>
        </div>
