    ...
    <form action="{{ route('admin.patients.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col lg:flex-row gap-8 px-4">
        ...
        <div class="flex-1 space-y-8">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="relative">
                                <select name="gender" required
                                        class="w-full h-16 px-6 border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all appearance-none cursor-pointer bg-slate-50/30">
            ...
            <div class="bg-white rounded-[3rem] border border-slate-100 p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)] transition-all duration-500"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="md:col-span-2 space-y-3 pt-4">
                        ...
                        <div class="relative">
                            <select name="kia_book_ownership" class="w-full h-14 px-6 border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all appearance-none cursor-pointer bg-slate-50/30">
            ...
            <div class="bg-white rounded-[3rem] border border-slate-100 p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)] transition-all duration-500"
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <input type="text" name="job" value="{{ old('job') }}" placeholder="Contoh: PNS, IRT..."
            ...
            <div class="bg-white rounded-[3rem] border border-slate-100 p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)] transition-all duration-500"
                 ...
                 x-transition:enter-end="opacity-100 transform translate-y-0">
                <div class="flex items-center gap-4 mb-10">
                    <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-700 text-white flex items-center justify-center shadow-lg shadow-orange-200">
                        <span class="material-symbols-outlined text-[24px]">elderly</span>
                    </div>
                    <div>
                        <h3 class="text-sm font-black text-slate-800 uppercase tracking-[0.2em]">Kemandirian Lansia</h3>
                        <p class="text-xs font-bold text-slate-400 mt-0.5">Status kemandirian dan tempat tinggal</p>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-3">
                        ...
                        <select name="living_status" class="w-full h-14 px-6 border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 focus:outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-500/5 transition-all bg-slate-50/30">
                            ...
                            <option value="Keluarga" {{ old('living_status') == 'Keluarga' ? 'selected' : '' }}>Bersama Keluarga</option>
                        </select>
                    </div>
                    <div class="space-y-3">
                        ...
                        <select name="independence_status" class="w-full h-14 px-6 border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 focus:outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-500/5 transition-all bg-slate-50/30">
                            <option value="Mandiri" {{ old('independence_status') == 'Mandiri' ? 'selected' : '' }}>Mandiri (A)</option>
                            <option value="Bantuan" {{ old('independence_status') == 'Bantuan' ? 'selected' : '' }}>Bantuan (B/C)</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            ...
                            @else
                                <select name="posyandu_id" required class="w-full h-16 px-6 border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all appearance-none cursor-pointer bg-slate-50/30">
