                        ...
                        <div class="space-y-3">
                            ...
                            <div class="relative w-full">
                                <select wire:model="posyandu_id"
                                    class="w-full h-16 pl-6 pr-12 appearance-none rounded-2xl border @error('posyandu_id') bg-red-50/10 text-red-900 border-red-400 focus:border-red-500 focus:ring-red-500/10 dark:bg-red-950/10 dark:text-red-400 dark:border-red-500/50 @else border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950 text-slate-800 dark:text-slate-200 focus:border-teal-500 dark:focus:border-teal-600 focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-teal-500/5 @enderror text-base font-semibold transition-all cursor-pointer">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="relative w-full">
                                <select wire:model="status"
                                    class="w-full h-16 pl-6 pr-12 appearance-none rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950 text-slate-850 dark:text-slate-200 focus:border-teal-500 dark:focus:border-teal-600 focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-teal-500/5 text-base font-semibold transition-all cursor-pointer">
