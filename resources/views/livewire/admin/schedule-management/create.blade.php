<div>
    ...
    <div class="w-full">
        <div class="bg-white rounded-3xl border border-slate-100 p-8 md:p-10 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.05)] relative overflow-hidden" style="contain: layout style;">
            ...
            <form wire:submit.prevent="save" class="max-w-3xl mx-auto space-y-12">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <input type="text" wire:model="title" placeholder="Contoh: Posyandu Balita RW 01 / Imunisasi"
                            class="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50/50 text-sm font-semibold text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-teal-500 focus:bg-white focus:ring-4 focus:ring-teal-500/5 transition-all">
                        @error('title')
                    ...
                    <div class="space-y-3">
                        ...
                        <textarea wire:model="description" rows="4" placeholder="Tuliskan catatan khusus atau instruksi untuk kader dan warga di sini..."
                            class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50/50 text-sm font-semibold text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-teal-500 focus:bg-white focus:ring-4 focus:ring-teal-500/5 transition-all resize-none"></textarea>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative w-full">
                            <select wire:model="posyandu_id"
                                class="w-full h-12 pl-4 pr-10 appearance-none rounded-xl border @error('posyandu_id') bg-red-50/10 text-red-900 border-red-400 focus:border-red-500 focus:ring-red-500/10 @else border-slate-200 bg-slate-50/50 text-slate-800 focus:border-teal-500 focus:bg-white focus:ring-4 focus:ring-teal-500/5 @enderror text-sm font-semibold transition-all cursor-pointer">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="space-y-3">
                            ...
                            <input type="datetime-local" wire:model="start_time"
                                class="w-full h-12 px-4 rounded-xl border border-slate-200 bg-slate-50/50 text-sm font-semibold text-slate-800 focus:outline-none focus:border-teal-500 focus:bg-white focus:ring-4 focus:ring-teal-500/5 transition-all">
                            @error('start_time')
                                <p class="text-xs font-bold text-red-500 ml-1 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" wire:model="location" placeholder="Gedung Posyandu / Balai Warga"
                                class="w-full h-12 pl-11 pr-4 rounded-xl border border-slate-200 bg-slate-50/50 text-sm font-semibold text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-teal-500 focus:bg-white focus:ring-4 focus:ring-teal-500/5 transition-all">
                        </div>
                        @error('location')
                            <p class="text-xs font-bold text-red-500 ml-1 mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative w-full">
                            <select wire:model="status"
                                class="w-full h-12 pl-4 pr-10 appearance-none rounded-xl border border-slate-200 bg-slate-50/50 text-slate-800 focus:border-teal-500 focus:bg-white focus:ring-4 focus:ring-teal-500/5 text-sm font-semibold transition-all cursor-pointer">
                    ...
                    {{-- Perulangan Kegiatan --}}
                    <div class="p-6 bg-slate-50 rounded-[1.8rem] border border-slate-100 space-y-4" style="contain: layout style;">
                ...
                <div class="pt-8 border-t border-slate-100 flex flex-col gap-6 w-full">
                    <div class="flex items-start gap-4 p-5 bg-teal-50/50 rounded-2xl border border-teal-100/50 w-full">
                    ...
                    <div class="flex flex-col-reverse sm:flex-row items-center justify-end gap-3 w-full">
                        <a href="{{ route('admin.schedules.index') }}"
                            class="w-full sm:w-auto h-14 px-8 flex items-center justify-center text-sm font-black text-slate-500 uppercase tracking-widest hover:text-slate-700 transition-colors text-center">
                            Batal
                        </a>
