...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-xl font-bold text-slate-900">Tambah Pedukuhan Baru</h1>
            <p class="text-sm text-slate-500 mt-0.5">Daftarkan wilayah pedukuhan baru ke sistem</p>
        </div>
    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-200 flex items-center gap-3">
            ...
            <div>
                <h2 class="text-sm font-bold text-slate-900">Informasi Pedukuhan</h2>
                ...
                <div class="relative">
                    ...
                    <textarea name="geo_location" rows="3"
                              ...
                              class="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-300 text-sm font-medium text-slate-800 placeholder:text-slate-400
                                     ...
                                     @error('geo_location') border-red-400 bg-red-50 @enderror">{{ old('geo_location') }}</textarea>
                </div>
                @error('geo_location')
                    <p class="mt-1 text-xs text-red-600 flex items-center gap-1">
                        <span class="material-symbols-outlined text-[13px]">error</span>{{ $message }}
