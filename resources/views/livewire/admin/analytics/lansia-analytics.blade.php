<div class="space-y-8 animate-fadeIn">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="relative overflow-hidden bg-white/85 backdrop-blur-md rounded-3xl p-6 border border-outline-variant/40 shadow-md transition-all duration-300 hover:shadow-lg hover:border-rose-450 group">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-label-sm font-bold text-outline uppercase tracking-wider">Hipertensi</span>
            </div>
            <div class="space-y-1">
                <div class="flex items-baseline gap-2">
                    <span class="text-4xl font-black text-slate-900 tracking-tight">{{ $metabolicRisks['hipertensi'] }}</span>
                    <span class="text-body-sm font-semibold text-outline">Lansia</span>
                </div>
                <h4 class="text-body-md font-bold text-slate-800">Tekanan Darah Tinggi</h4>
        ...
        <div class="relative overflow-hidden bg-white/85 backdrop-blur-md rounded-3xl p-6 border border-outline-variant/40 shadow-md transition-all duration-300 hover:shadow-lg hover:border-amber-400 group">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-label-sm font-bold text-outline uppercase tracking-wider">Gula Darah Tinggi</span>
            </div>
            <div class="space-y-1">
                <div class="flex items-baseline gap-2">
                    <span class="text-4xl font-black text-slate-900 tracking-tight">{{ $metabolicRisks['gula'] }}</span>
                    <span class="text-body-sm font-semibold text-outline">Lansia</span>
                </div>
                <h4 class="text-body-md font-bold text-slate-800">Hiperglikemia</h4>
        ...
        {{-- Kolesterol Tinggi --}}
        <div class="relative overflow-hidden bg-white/85 backdrop-blur-md rounded-3xl p-6 border border-outline-variant/40 shadow-md transition-all duration-300 hover:shadow-lg hover:border-blue-400 group">
            <div class="flex items-center justify-between mb-4">
                <div class="w-12 h-12 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center border border-blue-100 group-hover:bg-blue-500 group-hover:text-white transition-all duration-300">
                    <span class="material-symbols-outlined text-[26px]">heart_broken</span>
                </div>
                <span class="text-label-sm font-bold text-outline uppercase tracking-wider">Kolesterol Tinggi</span>
            </div>
            <div class="space-y-1">
                <div class="flex items-baseline gap-2">
                    <span class="text-4xl font-black text-slate-900 tracking-tight">{{ $metabolicRisks['kolesterol'] }}</span>
                    <span class="text-body-sm font-semibold text-outline">Lansia</span>
                </div>
                <h4 class="text-body-md font-bold text-slate-800">Hiperkolesterolemia</h4>
        ...
        {{-- Asam Urat Tinggi --}}
        <div class="relative overflow-hidden bg-white/85 backdrop-blur-md rounded-3xl p-6 border border-outline-variant/40 shadow-md transition-all duration-300 hover:shadow-lg hover:border-purple-400 group">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-label-sm font-bold text-outline uppercase tracking-wider">Asam Urat Tinggi</span>
            </div>
            <div class="space-y-1">
                <div class="flex items-baseline gap-2">
                    <span class="text-4xl font-black text-slate-900 tracking-tight">{{ $metabolicRisks['asamUrat'] }}</span>
                    <span class="text-body-sm font-semibold text-outline">Lansia</span>
                </div>
                <h4 class="text-body-md font-bold text-slate-800">Hiperurisemia</h4>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
        ...
        {{-- AL-01: Kategori Umur --}}
        <div class="bg-white/80 backdrop-blur-md rounded-3xl p-8 border border-outline-variant/40 shadow-md flex flex-col justify-between">
            <div>
                <div class="flex items-center gap-3 mb-4">
                    <span class="material-symbols-outlined text-indigo-600 text-[26px]">badge</span>
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="h-3 w-full bg-slate-100 rounded-full overflow-hidden p-0.5 border border-outline-variant/10">
                            <div class="h-full bg-indigo-400 rounded-full transition-all duration-500" style="width: {{ $praPct }}%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between items-center text-sm font-bold text-slate-700 mb-2">
                        ...
                        <div class="h-3 w-full bg-slate-100 rounded-full overflow-hidden p-0.5 border border-outline-variant/10">
                            <div class="h-full bg-indigo-550 rounded-full transition-all duration-500" style="width: {{ $lanPct }}%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between items-center text-sm font-bold text-slate-700 mb-2">
                        ...
                        <div class="h-3 w-full bg-slate-100 rounded-full overflow-hidden p-0.5 border border-outline-variant/10">
                            <div class="h-full bg-indigo-750 rounded-full transition-all duration-500" style="width: {{ $resPct }}%"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white/80 backdrop-blur-md rounded-3xl p-8 border border-outline-variant/40 shadow-md flex flex-col justify-between">
            <div>
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="text-lg font-bold text-slate-900">Indeks Massa Tubuh (IMT)</h3>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="h-2 w-full bg-slate-100 rounded-full overflow-hidden p-0.5 border border-outline-variant/10">
                            <div class="h-full bg-amber-400 rounded-full transition-all duration-500" style="width: {{ $kurangPct }}%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between items-center text-xs font-bold text-slate-700 mb-1.5">
                        ...
                        <div class="h-2 w-full bg-slate-100 rounded-full overflow-hidden p-0.5 border border-outline-variant/10">
                            <div class="h-full bg-teal-500 rounded-full transition-all duration-500" style="width: {{ $normalPct }}%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between items-center text-xs font-bold text-slate-700 mb-1.5">
                        ...
                        <div class="h-2 w-full bg-slate-100 rounded-full overflow-hidden p-0.5 border border-outline-variant/10">
                            <div class="h-full bg-orange-400 rounded-full transition-all duration-500" style="width: {{ $lebihPct }}%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between items-center text-xs font-bold text-slate-700 mb-1.5">
                        ...
                        <div class="h-2 w-full bg-slate-100 rounded-full overflow-hidden p-0.5 border border-outline-variant/10">
                            <div class="h-full bg-rose-500 rounded-full transition-all duration-500" style="width: {{ $obesitasPct }}%"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="h-3 w-full bg-slate-100 rounded-full overflow-hidden p-0.5 border border-outline-variant/10">
                            <div class="h-full bg-emerald-500 rounded-full transition-all duration-500" style="width: {{ $aPct }}%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between items-center text-sm font-bold text-slate-700 mb-2">
                        ...
                        <div class="h-3 w-full bg-slate-100 rounded-full overflow-hidden p-0.5 border border-outline-variant/10">
                            <div class="h-full bg-amber-500 rounded-full transition-all duration-500" style="width: {{ $bPct }}%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between items-center text-sm font-bold text-slate-700 mb-2">
                        ...
                        <div class="h-3 w-full bg-slate-100 rounded-full overflow-hidden p-0.5 border border-outline-variant/10">
                            <div class="h-full bg-rose-500 rounded-full transition-all duration-500" style="width: {{ $cPct }}%"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white/80 backdrop-blur-md rounded-3xl p-8 border border-outline-variant/40 shadow-md mt-6">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h3 class="text-lg font-bold text-slate-900">Tren Risiko Metabolik Lansia</h3>
            ...
            <button onclick="downloadChart(lansiaMetabolicChart, 'tren_risiko_metabolik_lansia')" class="p-2.5 text-slate-500 hover:text-slate-800 rounded-xl bg-slate-50 border border-slate-300 transition-colors shadow-xs cursor-pointer flex items-center justify-center" title="Unduh Gambar Grafik">
