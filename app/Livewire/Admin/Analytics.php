...
class Analytics extends BaseAdminComponent
{
    ...
    public function switchDrillDownCategory(string $newType): void
    {
        ...
        $typeName = match ($newType) {
            ...
            'lansia_obesity_sentral' => 'Obesitas Sentral',
            'lansia_eye_issue' => 'Gangguan Penglihatan',
            'lansia_ear_issue' => 'Gangguan Pendengaran',
            'lansia_puma_risk' => 'Skrining PUMA',
            'lansia_tbc_risk' => 'Skrining TBC',
            'lansia_mental_risk' => 'Skrining Jiwa',
