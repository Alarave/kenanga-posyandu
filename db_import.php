...
if (! file_exists($file)) {
    exit("<p style='color: red;'>Error: file 'database/db_snapshot.sql' not found. Make sure you ran db-export.bat before deploying.</p>");
}

$conn = new mysqli($host, $user, $pass, $db);
if ($conn->connect_error) {
    exit("<p style='color: red;'>Connection failed: ".$conn->connect_error.'</p>');
}
